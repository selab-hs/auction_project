package com.selab.auction.member.auth.redis;
...
public class RedisUtil {
    ...
    public void setBlackList(String key, Object obj, int minutes) {
        redisBlackListTemplate.setValueSerializer(new Jackson2JsonRedisSerializer(obj.getClass()));
        redisBlackListTemplate.opsForValue().set(key, obj, minutes, TimeUnit.MINUTES);
    }
